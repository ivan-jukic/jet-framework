exports = module.exports = function() {
    ...
    return function(socket, next) {
        try {
            var cookie = require(Jet.app.get("cwd") + "/node_modules/cookie-parser/node_modules/cookie");
            var parse = require(Jet.app.get("cwd") + "/node_modules/cookie-parser/lib/parse");
        } catch (e) {
            Jet.log(e);
        }
